      ...
      content: [
        {
          ...
          test: 'Quizz time',
          homework: 'Homework assignment #1',
        },
      ],
    },
    {
      title: 'Chap 2',
      content: [
        { courses: [{ title: 'Intro to something' }], test: 'Quizz time' },
      ],
    },
    {
      title: 'Conclu',
      content: [
        {
          courses: [{ title: 'Intro to something' }],
          homework: 'Homework assignment #2',
        },
      ],
    },
  ];
            ...
            >
              <Flex items={'center'} content={'space-between'} class={'w-100'}>
                <Flex items={'center'}>
                  ...
                  <Text bold text={item.title} size={14} />
                </Flex>
                ...
                return (
                  <>
                    {courseContent.courses &&
                      courseContent.courses.map((course, index) => (
                        <>
                          <Flex
                            items={'center'}
                            class={index > 0 ? 'pt-1' : ''}
                          >
                            <GrPersonalComputer />
                            <Text text={course.title} paddingLeft={10} />
                          </Flex>
                        </>
                      ))}
                    ...
                    {courseContent.test && (
                      <>
                        <Flex items={'center'} class={'pt-1'}>
                          <GoTasklist />
                          <Text text={courseContent.test} paddingLeft={10} />
                        </Flex>
                      </>
                    )}
...
export default function WithDescription({
  ...
  const _modalInfos = () => {
    modalInfos({
      title: (
        <Text text={title} bold display={'flex'} textClass={'text-center'} />
      ),
  ...
  return (
    <Flex column items={'center'} class={'border border-gray p-4'}>
      ...
      <Button
        className={'w-85 py-2 rounded-0 shadow-on-hover mb-3'}
      ...
      <Button
        className={'w-85 py-2 rounded-0 shadow-on-hover mt-3'}
        variant={'primary'}
      >
        Prendre ce cursus
      </Button>
