    ...
    <>
      <Layout>
        ...
        <Container className={'d-flex align-items-center flex-column py-4 my-5'}>
          <span css={css`font-family: Roboto Thin, sans-serif; font-size: 2rem;`}>Choisissez Vos Cours</span>

          <BlockSeparator color={'#007bff'} />

          <span className={'text-center'} css={css`font-family: Poppins Thin, sans-serif; font-size: 1.3rem;`}>
            Chaque cours comprend des vidéoconférences, des devoirs, des quiz, des projets et un examen final. Faites défiler vers le bas pour lire les programmes et pour regarder des aperçus et des exemples de conférences.
          </span>
        </Container>
          ...
          <Row className={'w-100 px-0 px-lg-5 mx-0'}>
            {
              courses.length && courses.map(course => (
                <Col sm={12} lg={4} className={'px-0 px-lg-3 mx-3 mx-lg-0 mb-4 mb-lg-0 pb-0 pb-lg-4'}>
                  <Course
                    withDescription
                    hasCertificated
    ...
    props: {
      courses: [
        ...
        },
        {
          ...
          description: 'Learn Cluster Analysis, Classification and Regression, SVM, SVC, SVR, Dimensionality Reduction, Apache Spark, Network Mining, Text Mining, Natural Language Processing, Count Vectorizer, TFIDF and more. Prerequisites: Python 2 or Python 3. This course is self-paced but the assignments and tests are mandatory and cannot be skipped. On average, our students complete the whole course in 8-10 weeks.',
          price: 75000
        }
      ]
    },
